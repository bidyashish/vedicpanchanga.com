const de: Record<string, string> = {
  ...
  nav_bala: "Bala",
  bala_title: "Tarabala- und Chandrabala-Rechner",
  bala_subtitle:
    "Wähle einen Zeitraum und sieh die genauen täglichen Tarabala- und Chandrabala-Wechsel",
  bala_calculate: "Bala berechnen",
  bala_results: "Bala-Ergebnisse",
  bala_calendar_view: "Kalenderansicht",
  bala_favorable_days: "Tage mit gemeinsamem günstigem Zeitfenster",
  bala_common_windows: "Beide günstig",
  bala_no_common_window: "Kein gemeinsames günstiges Zeitfenster",
  bala_tarabala: "Tarabala",
  bala_chandrabala: "Chandrabala",
  bala_house: "Haus",
  bala_cycle: "Zyklus",
  bala_favorable: "Günstig",
  bala_unfavorable: "Ungünstig",
  bala_rule_note:
    "Verwendet siderische Mondpositionen nach Lahiri und lokale Kalendertage. Günstige Taras: 2, 4, 6, 8, 9; günstige Mondhäuser: 1, 3, 6, 7, 10, 11. Manche Traditionen verwenden andere Paksha-Regeln.",
  ...
  bala_do: "Empfohlen",
  bala_dont: "Vermeiden",
  bala_janma_result: "Seelische Anspannung und Gefahr für den Körper.",
  bala_janma_do: "Erledige achtsam gewohnte Aufgaben mit geringem Risiko.",
  bala_janma_dont: "Beginne nichts Neues, reise nicht und triff keine wichtigen Entscheidungen.",
  bala_sampat_result: "Wohlstand, Gedeihen und Gewinn.",
  bala_sampat_do: "Regle Finanzen, investiere und beginne wichtige Arbeiten.",
  bala_sampat_dont: "Gehe nicht leichtfertig mit Geld um; prüfe Chancen sorgfältig.",
  bala_vipat_result: "Gefahr, Unfälle und Verluste.",
  bala_vipat_do: "Sei besonders bei Reisen und Finanzen äußerst vorsichtig.",
  bala_vipat_dont: "Gehe keine Risiken ein, beginne keine Projekte und meide Konflikte.",
  bala_kshema_result: "Wohlbefinden, Gedeihen und Sicherheit.",
  bala_kshema_do: "Reise, suche medizinische Hilfe, pflege Beziehungen und Gesundheit.",
  bala_kshema_dont:
    "Vernachlässige deine Gesundheit nicht und nimm Frieden nicht als selbstverständlich.",
  bala_pratyak_result: "Hindernisse, Feindschaft und Widerstand.",
  bala_pratyak_do: "Halte dich zurück und arbeite selbstständig.",
  bala_pratyak_dont: "Beginne keine Partnerschaften, bitte nicht um Gefallen und meide Streit.",
  bala_sadhana_result: "Leistung, Erfolg und erreichte Ziele.",
  bala_sadhana_do: "Verfolge Ziele, beginne zu lernen und arbeite auf Erfolg hin.",
  bala_sadhana_dont: "Verschiebe wichtige Arbeit nicht und zweifle nicht an deinen Fähigkeiten.",
  bala_naidhana_result: "Gefahr, Leid und äußerst ungünstige Umstände.",
  bala_naidhana_do: "Meditiere, bete und erledige nur notwendige Pflichten.",
  bala_naidhana_dont: "Unternimm keine wichtigen Aktivitäten oder Reisen.",
  bala_mitra_result: "Hilfe von Freunden und günstige Ergebnisse.",
  bala_mitra_do: "Knüpfe Kontakte, arbeite zusammen und sei gesellschaftlich aktiv.",
  bala_mitra_dont: "Isoliere dich nicht und misstraue anderen nicht grundlos.",
  bala_parama_mitra_result: "Äußerst günstig, mit starken Freundschaften und Erfolg.",
  bala_parama_mitra_do: "Nimm günstige Vorhaben und wichtige Lebensereignisse in Angriff.",
  bala_parama_mitra_dont: "Verpasse keine Chancen durch Untätigkeit.",
  bala_chandra_favorable_result: "Gute mentale Stärke, positive Gedanken und Erfolg bei Vorhaben.",
  bala_chandra_favorable_do:
    "Triff wichtige Entscheidungen, beginne Aufgaben und begegne Menschen.",
  bala_chandra_favorable_dont: "Lass Selbstüberschätzung nicht zu Nachlässigkeit führen.",
  bala_chandra_unfavorable_result:
    "Innere Unruhe, Verwirrung, negative Gedanken und Unentschlossenheit.",
  bala_chandra_unfavorable_do: "Sei geduldig, meditiere und bleibe bei Routineaufgaben.",
  bala_chandra_unfavorable_dont:
    "Triff keine wichtigen Entscheidungen, streite nicht und beginne nichts Neues.",
