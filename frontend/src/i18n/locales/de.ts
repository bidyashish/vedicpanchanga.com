const de: Record<string, string> = {
  ...
  festivals_eyebrow: "Hinduistische Feste",
  festivals_title: "Fest-, Vrata- und Shraddha-Termine für deine Stadt",
  festivals_subtitle:
    "Jedes Fest, jede Ekadashi, Sankranti, Finsternis und Pitru-Paksha-Tithi wird für den gewählten Ort aus der Ephemeride berechnet, mit exakten Ortszeiten.",
  festivals_next_up: "Als Nächstes",
  festivals_show_past: "Frühere Termine anzeigen",
  festivals_hide_past: "Frühere Termine ausblenden",
  festivals_location_note:
    "Berechnet für {0}; alle Zeiten sind Ortszeit dieses Ortes. Dasselbe Fest kann anderswo einen Tag früher oder später fallen.",
  festivals_none: "Für diese Auswahl gibt es keine Feste.",
  festivals_dates_short: "Termine",
  festivals_major_only: "Nur Hauptfeste",
  festivals_periods: "Besondere Zeiträume",
  festivals_period_days: "{0} Tage",
  festivals_today: "Heute",
  festivals_tomorrow: "Morgen",
  festivals_in_days: "in {0} Tagen",
  festivals_ongoing: "Läuft",
  festivals_ended: "Beendet",
  festivals_day_of: "Tag {0} von {1}",
  festivals_tithi_span: "Tithi",
  festivals_nakshatra_span: "Nakshatra",
  festivals_parana: "Parana (Fastenbrechen)",
  festivals_moment: "Genauer Zeitpunkt",
  festivals_sun_enters: "Sonne tritt in {0} ein",
  festivals_eclipse: "Finsternis",
  festivals_eclipse_max: "Maximum der Finsternis",
  festivals_eclipse_total: "Total",
  festivals_eclipse_partial: "Partiell",
  festivals_eclipse_annular: "Ringförmig",
  festivals_eclipse_hybrid: "Hybrid",
  festivals_eclipse_penumbral: "Halbschatten",
  festivals_eclipse_note:
    "Finsterniszeiten sind geozentrisch; von deiner Stadt aus ist sie eventuell nicht sichtbar.",
  festivals_adhika: "Adhika (Schaltmonat)",
  festivals_day_after: "Tag nach {0}",
  festivals_friday_before: "Freitag vor {0}",
  festivals_kala_purvahna: "Purvahna-Puja-Zeit (Vormittag)",
  festivals_kala_madhyahna: "Madhyahna-Puja-Zeit (Mittag)",
  festivals_kala_aparahna: "Aparahna-Zeit (Nachmittag)",
  festivals_kala_sayahna: "Sayahna-Zeit (Abend)",
  festivals_kala_pradosh: "Pradosh-Puja-Zeit",
  festivals_kala_nishita: "Nishita-Puja-Zeit (Mitternacht)",
  festivals_kala_arunodaya: "Arunodaya-Bad (vor der Dämmerung)",
  festivals_kala_moonrise: "Mondaufgang",
  festivals_kala_muhurta: "Muhurta",
  festivals_loading: "Festkalender für deine Stadt wird berechnet...",
  festivals_error: "Der Festkalender konnte nicht berechnet werden.",
  festivals_year_prev: "Vorheriges Jahr",
  festivals_year_next: "Nächstes Jahr",

  // Festival names (fest_<id>) - ids match backend/festivals.py FESTIVAL_NAMES_EN
  fest_chaitra_navratri: "Chaitra Navratri",
  fest_hindu_new_year: "Hinduistisches Neujahr (Gudi Padwa, Ugadi)",
  ...
  fest_navratri_begins: "Sharad Navratri beginnt",
  fest_maha_shashthi: "Maha Shashthi (Durga Puja beginnt)",
  ...
  fest_solar_new_year: "Solares Neujahr (Baisakhi, Vishu, Puthandu)",
  fest_vishwakarma_puja: "Vishwakarma Puja",
  fest_pongal: "Pongal",
  fest_somavati_amavasya: "Somavati Amavasya",
  fest_surya_grahan: "Sonnenfinsternis (Surya Grahan)",
  fest_chandra_grahan: "Mondfinsternis (Chandra Grahan)",
  fest_adhika_masa: "Adhika Masa (Schaltmonat)",
  fest_chaturmas: "Chaturmas (Vishnus Schlaf)",
  fest_pitru_paksha: "Pitru Paksha",
  fest_sharad_navratri: "Sharad Navratri",
  fest_durga_puja: "Durga Puja",
  fest_purnima: "Purnima (Vollmond)",
  fest_amavasya: "Amavasya (Neumond)",
  ...
  upto: "bis",
  balam_next_sunrise: "bis zum nächsten Sonnenaufgang",
