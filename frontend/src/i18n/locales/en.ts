const en: Record<string, string> = {
  ...
  nav_bala: "Bala",
  bala_title: "Tarabala & Chandrabala Calculator",
  bala_subtitle: "Choose a date range and see exact daily Tarabala and Chandrabala changes",
  bala_calculate: "Calculate Bala",
  bala_results: "Bala Results",
  bala_calendar_view: "Calendar View",
  bala_favorable_days: "days with a common favourable window",
  bala_common_windows: "Both Favourable",
  bala_no_common_window: "No common favourable window",
  bala_tarabala: "Tarabala",
  bala_chandrabala: "Chandrabala",
  bala_house: "House",
  bala_cycle: "Cycle",
  bala_favorable: "Favourable",
  bala_unfavorable: "Unfavourable",
  bala_rule_note:
    "Uses Lahiri sidereal Moon positions and local civil days. Favourable Taras: 2, 4, 6, 8, 9; favourable Moon houses: 1, 3, 6, 7, 10, 11. Some traditions use different Paksha rules.",
  ...
  bala_do: "Do",
  bala_dont: "Don't",
  bala_janma_result: "Mental tension & danger to body.",
  bala_janma_do: "Perform routine, low-risk tasks. Be mindful.",
  bala_janma_dont: "Start new ventures, travel, or make critical decisions.",
  bala_sampat_result: "Wealth, prosperity, and gain.",
  bala_sampat_do: "Engage in financial activities, investments, and start important work.",
  bala_sampat_dont: "Be reckless with money; assess opportunities carefully.",
  bala_vipat_result: "Dangers, accidents, and losses.",
  bala_vipat_do: "Be extra cautious in all activities, especially travel and finances.",
  bala_vipat_dont: "Take risks, start new projects, or get into conflicts.",
  bala_kshema_result: "Well-being, prosperity, and security.",
  bala_kshema_do: "Travel, seek medical help, build relationships, and work on well-being.",
  bala_kshema_dont: "Neglect your health or take peace for granted.",
  bala_pratyak_result: "Obstacles, enmity, and opposition.",
  bala_pratyak_do: "Keep a low profile, work independently.",
  bala_pratyak_dont: "Start partnerships, seek favors, or engage in arguments.",
  bala_sadhana_result: "Achievement, success, and goals realized.",
  bala_sadhana_do: "Pursue goals, start learning, and put in efforts for success.",
  bala_sadhana_dont: "Postpone important work or doubt your abilities.",
  bala_naidhana_result: "Danger, suffering, highly unfavorable.",
  bala_naidhana_do: "Meditate, pray, and perform only essential duties.",
  bala_naidhana_dont: "Engage in any important activity. Avoid travel at all costs.",
  bala_mitra_result: "Help from friends and favorable outcomes.",
  bala_mitra_do: "Network, collaborate, and engage in social activities.",
  bala_mitra_dont: "Isolate yourself or mistrust others' intentions.",
  bala_parama_mitra_result: "Extremely favorable, great friendships, and success.",
  bala_parama_mitra_do: "Engage in any auspicious activity; excellent for major life events.",
  bala_parama_mitra_dont: "Miss opportunities due to inaction.",
  bala_chandra_favorable_result:
    "Good mental strength, positive thoughts, and success in endeavors.",
  bala_chandra_favorable_do: "Make important decisions, start new tasks, and interact with people.",
  bala_chandra_favorable_dont: "Let overconfidence lead to carelessness.",
  bala_chandra_unfavorable_result:
    "Mental anxiety, confusion, negative thoughts, and indecisiveness.",
  bala_chandra_unfavorable_do: "Practice patience, meditate, and stick to routine tasks.",
  bala_chandra_unfavorable_dont: "Make major decisions, get into arguments, or start new ventures.",
