const en: Record<string, string> = {
  ...
  festivals_title: "Festival, vrat and Shraddha dates for your city",
  festivals_subtitle:
    "Every festival, Ekadashi, Sankranti, eclipse and Pitru Paksha tithi is computed from the ephemeris for the place you choose, with exact local timings.",
  ...
  festivals_location_note:
    "Calculated for {0}; every time shown is local to that place. The same festival can fall a day earlier or later in another city.",
  festivals_none: "No festivals to show for this selection.",
  festivals_dates_short: "dates",
  festivals_major_only: "Major festivals only",
  festivals_periods: "Special periods",
  festivals_period_days: "{0} days",
  festivals_today: "Today",
  festivals_tomorrow: "Tomorrow",
  festivals_in_days: "in {0} days",
  festivals_ongoing: "Ongoing",
  festivals_ended: "Ended",
  festivals_day_of: "Day {0} of {1}",
  festivals_tithi_span: "Tithi",
  festivals_nakshatra_span: "Nakshatra",
  festivals_parana: "Parana (breaking the fast)",
  festivals_moment: "Exact moment",
  festivals_sun_enters: "Sun enters {0}",
  festivals_eclipse: "Eclipse",
  festivals_eclipse_max: "Greatest eclipse",
  festivals_eclipse_total: "Total",
  festivals_eclipse_partial: "Partial",
  festivals_eclipse_annular: "Annular",
  festivals_eclipse_hybrid: "Hybrid",
  festivals_eclipse_penumbral: "Penumbral",
  festivals_eclipse_note:
    "Eclipse times are geocentric and the eclipse may not be visible from your city.",
  festivals_adhika: "Adhika (extra month)",
  festivals_day_after: "Day after {0}",
  festivals_friday_before: "Friday before {0}",
  festivals_kala_purvahna: "Purvahna puja time (morning)",
  festivals_kala_madhyahna: "Madhyahna puja time (midday)",
  festivals_kala_aparahna: "Aparahna time (afternoon)",
  festivals_kala_sayahna: "Sayahna time (evening)",
  festivals_kala_pradosh: "Pradosh puja time",
  festivals_kala_nishita: "Nishita puja time (midnight)",
  festivals_kala_arunodaya: "Arunodaya snan (pre-dawn)",
  festivals_kala_moonrise: "Moonrise",
  festivals_kala_muhurta: "Muhurta",
  festivals_loading: "Computing the festival calendar for your city...",
  festivals_error: "Could not compute the festival calendar.",
  festivals_year_prev: "Previous year",
  festivals_year_next: "Next year",

  // Festival names (fest_<id>) - ids match backend/festivals.py FESTIVAL_NAMES_EN
  fest_chaitra_navratri: "Chaitra Navratri",
  fest_hindu_new_year: "Hindu New Year (Gudi Padwa, Ugadi)",
  ...
  fest_navratri_begins: "Sharad Navratri begins",
  fest_maha_shashthi: "Maha Shashthi (Durga Puja begins)",
  ...
  fest_solar_new_year: "Solar New Year (Baisakhi, Vishu, Puthandu)",
  fest_vishwakarma_puja: "Vishwakarma Puja",
  fest_pongal: "Pongal",
  fest_somavati_amavasya: "Somavati Amavasya",
  fest_surya_grahan: "Solar Eclipse (Surya Grahan)",
  fest_chandra_grahan: "Lunar Eclipse (Chandra Grahan)",
  fest_adhika_masa: "Adhika Masa (extra month)",
  fest_chaturmas: "Chaturmas (Vishnu's sleep)",
  fest_pitru_paksha: "Pitru Paksha",
  fest_sharad_navratri: "Sharad Navratri",
  fest_durga_puja: "Durga Puja",
  fest_purnima: "Purnima (full moon)",
  fest_amavasya: "Amavasya (new moon)",
