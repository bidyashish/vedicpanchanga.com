  ...
  return (
    <div className="py-6 space-y-6 max-w-3xl mx-auto">
      ...
      <Section title="Information We Do Not Collect">
        <div className="space-y-3 text-meta text-ink leading-relaxed">
          <p>
            We do not maintain user accounts, do not run analytics that profile individual visitors,
            and do not sell, rent, or share personal data with data brokers.
          </p>
        </div>
      </Section>
      ...
      <Section title="Information Processed in Your Request">
        <div className="space-y-3 text-meta text-ink leading-relaxed">
          <p>
            ...
            not written to a database and are not retained between requests.
          </p>
          <p>
      ...
      <Section title="Cookies & Advertising">
        <div className="space-y-3 text-meta text-ink leading-relaxed">
          <p>
            We do not set tracking cookies of our own. Advertising cookies, when present, come from
      ...
      <Section title="Children's Privacy">
        <div className="space-y-3 text-meta text-ink leading-relaxed">
          <p>
            ...
            information, please contact us and we will take reasonable steps to address the concern.
          </p>
        </div>
      </Section>
      ...
      <Section title="Your Rights (GDPR / UK GDPR / CCPA)">
        <div className="space-y-3 text-meta text-ink leading-relaxed">
          <p>
            Because we do not store personal data, there is generally nothing on our side to access,
            correct, or delete. For requests related to ad personalization, please use Google's
            controls linked above. For anything else, reach out to{" "}
            <a
